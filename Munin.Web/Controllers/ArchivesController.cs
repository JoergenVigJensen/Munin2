...
namespace Munin.Web.Controllers
{
    public class ArchivesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ArchiveId,ArchiveNb,Title,Definition,ArchiveType,Established,ClosedDate,Comment")] Archive archive)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ArchiveId,ArchiveNb,Title,Definition,ArchiveType,Established,ClosedDate,Comment")] Archive archive)
        {
            if (ModelState.IsValid)
            {
